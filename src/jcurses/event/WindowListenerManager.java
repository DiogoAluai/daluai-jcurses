...
/**
 * This class implements a listener manager to manage <code>jcurses.event.ValueChangedEvent</code> instances and listener on these. Only possible type of
 * handled events is <code>jcurses.event.ValueChangedEvent<code/>,
