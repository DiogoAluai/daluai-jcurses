...
public class PopUpList extends Widget {
	...
	private static CharColor __popUpDefaultColors = new CharColor(CharColor.WHITE, CharColor.BLACK);
	...
	private static CharColor __focusedPopUpDefaultColors = new CharColor(CharColor.BLUE, CharColor.WHITE, CharColor.REVERSE);
