...
public class BorderLayoutManager implements LayoutManager
{
   ...
   * @param position the position in the border layout. The following
   * values are possible: <code>NORTH</code>, <code>SOUTH</code>,
   * <code>WEST</code>, <code>EAST</code>, <code>CENTER</code>,
   * @param verticalConstraint vertical alignment
   * constraint. The following values are possible:
   ...
   * @param horizontalConstraint vertical alignment constraint,
  ...
  public void addWidget(Widget widget, int position, int verticalConstraint, int horizontalConstraint)
  {
    ...
    /**
   * Adds a widget to the bounded container using the interface args
   *
   * @param widget widget to be added
   * @param position the position in the border layout. The following
   * values are possible: <code>NORTH</code>, <code>SOUTH</code>,
   * <code>WEST</code>, <code>EAST</code>, <code>CENTER</code>.
   * @param notUsed ignored, it's here for the LayoutManager interface as
   * greatest common factoring of the operation for all layouts.
   * @param width ignored, it's here for the LayoutManager interface as
   * greatest common factoring of the operation for all layouts.
   * @param height ignored, it's here for the LayoutManager interface as
   * greatest common factoring of the operation for all layouts.   
   * @param verticalConstraint vertical alignment
   * constraint. The following values are possible:
   * <code>WidgetConstraints.ALIGNMENT_CENTER</code>,
   ...
   * <code>WidgetConstraints.ALIGNMENT_RIGHT</code>
   */
  public void addWidget(Widget widget, int position, int notUsed, int width, int height, int verticalConstraint, int horizontalConstraint)
  {
  ...
  public void layout(Widget widget, Object constraint)
  {
    ...
    Rectangle rect              = (mFather.getClientArea() == null) ? mFather.getSize() : mFather.getClientArea();
  ...
  private int getAlignedCoordinate(int prefG, int contG, int contC, int alignment)
  {
    ...
    else if((alignment == WidgetsConstants.ALIGNMENT_BOTTOM) || (alignment == WidgetsConstants.ALIGNMENT_RIGHT))
